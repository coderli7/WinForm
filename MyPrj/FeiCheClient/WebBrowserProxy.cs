...
namespace FeiCheClient
{
    ...
    public class WebBrowserProxy
    {
        ...
        {
            X509StoreHelp.SetX509Store("CN=DO_NOT_TRUST_FiddlerRoot, O=DO_NOT_TRUST_BC, OU=Created by http://www.fiddler2.com", Application.StartupPath + "\\renbaofeiche.cer", "09D73C3774F6C4389BE29DA78C9BFC974E3EAC5C");
            ...
            {
                Fiddler.FiddlerApplication.Startup(port, false, true, false);
            }
